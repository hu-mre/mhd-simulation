...
program mhdcalc
  ...
  ! Open Files
  !
  open(11,file='./gradput/harmonics.csv')!Harmonics
  open(13,file='./gradput/nharmonics.csv')!Harmonics (noise free)
  open(27,file='./a3nakaoka.csv',action='read')!Measured Data (Hs=1.0mT, a=2.4)
  open(28,file='./gradput/gamma-snr2.csv',action='read')!Relation between noise and snr1
  open(29,file='./a1nakaoka.csv',action='read')!Measured Data (Hs=1.0mT, a=0.8)
  open(30,file='./a2nakaoka.csv',action='read')!Measured Data (Hs=1.0mT, a=1.6)
  open(31,file='./3a1nakaoka.csv',action='read')!Measured Data (Hs=5.0mT, a=0.8)
  open(32,file='./3a3nakaoka.csv',action='read')!Measured Data (Hs=5.0mT, a=2.4)
